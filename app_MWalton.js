...
let optionChanged = document.getElementById("#selDataset");
...
optionChanged.addEventListener("change", updateBarPlotly);
...
optionChanged.addEventListener("change", updateBubblePlotly);
...
optionChanged.addEventListener("change", updateDemogPanel);
